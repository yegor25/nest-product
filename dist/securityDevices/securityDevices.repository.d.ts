...
export declare class SecurityDevicesRepository {
    private securityDevicesModel;
    constructor(securityDevicesModel: Model<SecurityDevices>);
    create(dto: createSecurityDevicesDto): Promise<import("mongoose").Document<unknown, {}, SecurityDevices> & SecurityDevices & Required<{
