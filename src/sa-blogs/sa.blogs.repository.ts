...
import { SortDirection, createdDtoBlogType, paramsBlogPaginatorType, responseDtoBlogType } from "../blogs/blog.schema";
...
export class SuperAdminBlogsRepository {
    ...
    async findBlogs(params: paramsBlogPaginatorType):Promise<responseDtoSqlBlogType>{
        ...
        const totalCount = await this.dataSource.query<{count: string}[]>(totalCountQuery)
